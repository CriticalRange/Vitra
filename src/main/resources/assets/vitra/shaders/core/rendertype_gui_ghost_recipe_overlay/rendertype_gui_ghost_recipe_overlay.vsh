// rendertype_gui_ghost_recipe_overlay.vsh - Vertex Shader
// Minecraft 1.21.1 GLSL to HLSL Shader Model 5.0 conversion
// Used for ghost recipe overlay in crafting GUI (shows available recipes with semi-transparent items)
