// rendertype_entity_cutout.vsh - Vertex Shader
// Minecraft 1.21.1 GLSL to HLSL Shader Model 5.0 conversion
// Used for rendering entities with cutout transparency (alpha test at 0.1)
// Same as entity.vsh - cutout happens in fragment shader
...
VS_OUTPUT main(VS_INPUT input) {
 ...
 output.Position = mul(float4(input.Position, 1.0), MVP);
    ...
    // Calculate fog distance (VulkanMod pattern: shape 0 = spherical)
