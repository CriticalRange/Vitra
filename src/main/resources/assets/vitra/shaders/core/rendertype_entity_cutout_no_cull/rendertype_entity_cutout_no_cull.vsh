// rendertype_entity_cutout_no_cull.vsh - Vertex Shader
// Minecraft 1.21.1 GLSL to HLSL Shader Model 5.0 conversion
// Used for rendering entities with cutout transparency and no backface culling
...
VS_OUTPUT main(VS_INPUT input) {
 ...
 output.Position = mul(MVP, float4(input.Position, 1.0));
    ...
    // Calculate fog distance using FogShape (vanilla pattern)
