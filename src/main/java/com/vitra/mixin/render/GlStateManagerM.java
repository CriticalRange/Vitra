...
public class GlStateManagerM {
    ...
    public static void _bindTexture(int i) {
        ...
        com.vitra.render.dx11.D3D11GlTexture.bindTexture(i);
    }
    ...
    public static void _texImage2D(int target, int level, int internalFormat, int width, int height, int border, int format, int type, @Nullable IntBuffer pixels) {
        ...
        int boundTextureId = com.vitra.render.dx11.D3D11GlTexture.getBoundTexture(
            com.vitra.render.dx11.D3D11GlTexture.getActiveTextureSlot()
        );
        ...
        com.vitra.render.dx11.D3D11GlTexture.texImage2D(
    ...
    public static void _texSubImage2D(int target, int level, int offsetX, int offsetY, int width, int height, int format, int type, long pixels) {
        ...
        com.vitra.render.dx11.D3D11GlTexture.texSubImage2D(
    ...
    public static void _activeTexture(int i) {
        ...
        com.vitra.render.dx11.D3D11GlTexture.activeTexture(i);
    }
    ...
    public static void _pixelStore(int pname, int param) {
        ...
        switch (pname) {
            case GL_UNPACK_ROW_LENGTH:
                com.vitra.render.dx11.D3D11GlTexture.setUnpackRowLength(param);
                break;
            case GL_UNPACK_SKIP_ROWS:
                com.vitra.render.dx11.D3D11GlTexture.setUnpackSkipRows(param);
                break;
            case GL_UNPACK_SKIP_PIXELS:
                com.vitra.render.dx11.D3D11GlTexture.setUnpackSkipPixels(param);
                break;
        }
    ...
    public static int _genTexture() {
        ...
        return com.vitra.render.dx11.D3D11GlTexture.genTextureId();
    }
    ...
    public static void _deleteTexture(int i) {
        ...
        com.vitra.render.dx11.D3D11GlTexture.deleteTexture(i);
    }
