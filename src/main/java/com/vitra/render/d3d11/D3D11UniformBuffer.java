...
/**
 * D3D11 Uniform Buffer Object (Constant Buffer) manager.
 * Manages uniform data and uploads to GPU constant buffers.
 */
public class D3D11UniformBuffer {
    private static final Logger LOGGER = LoggerFactory.getLogger(D3D11UniformBuffer.class);
     ...
     */
    public D3D11UniformBuffer(int slot, int size) {
        this.slot = slot;
     ...
     * @param pipeline The pipeline to upload to
     */
    public void upload(D3D11Pipeline pipeline) {
        dirty = true;
