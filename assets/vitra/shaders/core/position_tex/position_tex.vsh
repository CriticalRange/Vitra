...
VS_OUTPUT main(VS_INPUT input) {
    ...
    // CRITICAL FIX: Use pre-multiplied MVP matrix (VulkanMod pattern)
    // MVP is computed on CPU as: Proj * ModelView
    // This avoids matrix layout/transpose issues between OpenGL and DirectX
